...
The \emph{Khovanov--Seidel curve model}~\cite[Sect.~4]{kho.sei:02} is a mapping from curves to objects of \(\mathcal{A}_{n+1}\) up to an overall grading and homological shift, as illustrated in~\cref{fig:curveModel}.
