...
\address{
	...
	\addressmark{2}Universitat de Barcelona \& Centre de Recerca Matemàtica, Spain
}
...
Thus \(\alpha\) and \(\alpha'\) are compatible (as in~\cref{def:incompatibilityDegree}) if and only if \({\Ext_{\mathcal{A}_m}^1(X, X') = 0}\).
