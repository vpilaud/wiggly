...
%
\begin{figure}[b]
\centerline{\includegraphics[scale=.61]{figures/wigglyFan}\qquad\input{figures/wigglyhedron}}
\caption{The wiggly fan~$\wigglyFan_2$ (left) and the wigglyhedron~$\wigglyhedron_2$ (right).}
...
However, the cohomology filtration is highly constrained if \(X\) is spherical, and these constraints are given by wiggly pseudotriangulations (see \cref{prop:wigglyPseudotriangulations}).
This categorical interpretation of the pseudotriangulations was our initial motivation to study the wiggly complex.
...
\label{prop:hn-filtration}
  ...
  Then
  \begin{compactenum}
  \item \(T\) is a subset of a wiggly pseudotriangulation.
