...
\item Otherwise, $a$ and $a'$ are pointed, and
\[
...
Define $\widetilde R$ on $\widetilde {\wigglyArcs_P}$, so that the only linear dependence among its values is:
\[
2\pth{\widetilde R((l,i))+\widetilde R((r,i))} - \pth{\widetilde R((u,i))+\widetilde R((d,i))}=0.
\]
%
