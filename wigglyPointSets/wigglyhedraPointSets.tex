...
and let~$\b{R} : V \to \R^d$ be a vector configuration and~$f : V \to \R^+$ be a height function.
...
%\paco{revisar que est\'a claro cuando se consideran $T$ y $\simplex$ como ``complejos simpliciales abstractos'' y cuando como abanico y complejo simplicial geométrico, respectivamente}
  ...
  Since $T$ is a triangulation covering $\cone{\b{R}(V)}$, there is a unique $G\in T$ such that
  $x\in \relint{G}$.
  As $x\in \cone{\b{R}(F)} \cap\cone{G}$, there are two convex combinations
  \[
  ...
  and, along the ray $x$, $\conv{f\, G}$, a face of the convex hull,
  lies strictly below $\conv{f\, \b{R}(F)}$, so
  \paco{Why are there no cancellations in this formula?}
  \david{There may be some cancellations, but the result cannot be zero because that would imply that
