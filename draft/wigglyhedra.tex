...
We now describe the \(t\)-structure induced by the full subcategory of \emph{linear complexes} of \(\mathcal{C}_m\); a variant of this construction is described in~\cite[Section 2.5]{lic.que:21}.
