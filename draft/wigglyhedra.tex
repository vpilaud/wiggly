...
\begin{definition}
The category \(\mathcal{C}_m\) is defined to be the smallest full, isomorphism-closed triangulated subcategory of \(D^b(A_m\text{-mod})\) containing all the objects \(P_i\langle j \rangle\).
\end{definition}
