...
%
%\vspace{.5cm}
%\centerline{\includegraphics[width=\textwidth]{manyAssociahedra1}}
%\vspace{.5cm}
%\centerline{\includegraphics[width=\textwidth]{manyAssociahedra2}}
%
%\vspace{-.2cm}
...
\end{center}
\vspace{-.2cm}
\centerline{\includegraphics[scale=.78]{associahedronLoday}}
\vspace{-.4cm}
...
\vspace{.1cm}
\centerline{\includegraphics[scale=1.5]{secondaryPolytope}}
\vspace{1cm}
\end{minipage}
&&&
\begin{minipage}[t]{8.5cm}
...
\hspace{-.4cm}\boxed{\begin{minipage}{2.5cm} \smallskip \begin{center} \blue Cluster \\ algebras \\[-1.2cm] ~\end{center} \end{minipage}} \\
\vspace{-3cm}
\centerline{\hspace{2.5cm}\input{figures/cyclohedronCFZ}}
...
%
%\vspace{.3cm}
%\centerline{\raisebox{1cm}{\includegraphics[scale=2.2]{LodayVector}} \qquad  \includegraphics[scale=1.15]{associahedronLoday}}
%
%\end{slide}
%
%%%%%%%%%
...
\vspace{.2cm}
\centerline{\includegraphics[width=\textwidth]{polygonsHohlwegLange}}

\vspace{-.3cm}
\dots to obtain different realizations of the associahedron

\vspace{.1cm}
\centerline{\includegraphics[scale=2]{associahedronLodayHL}}
