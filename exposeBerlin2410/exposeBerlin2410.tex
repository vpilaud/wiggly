...
\emph{pseudotriangle} $=$ cell of degree $3$ \qquad \emph{pseudoquadragle} $=$ cell of degree $4$

\vspace{.4cm}
\centerline{\includegraphics[scale=3]{wigglyPseudodissections}}

\vspace{.1cm}
\theo{PROP}{The inclusion maximal wiggly pseudodissections are the pseudotriangulations, and contain $2n-1$ internal arcs and $n$ cells.}
...
\theo{PROP}{Any wiggly pseudoquadrangle has exactly two wiggly diagonals, and they either cross or are non pointed.}

\vspace{.1cm}
\centerline{\includegraphics[scale=2]{diagonalsPseudoquadrangles}}
...
\vspace{.3cm}
\centerline{\includegraphics[scale=3]{wigglyFlip}}
...
\vspace{.5cm}
\theo{PROP}{The wiggly flip graph $\wigglyFlipGraph_n$ is $(2n-1)$-regular and connected.}

\vspace{.5cm}
\centerline{\includegraphics[scale=1.7]{wigglyComplex} \hspace{-2cm} \includegraphics[scale=1.7]{wigglyComplexDual}}
...
\begin{slide}{Bijection}

\vspace{1cm}
\centerline{\includegraphics[scale=1.42]{wigglyPseudotriangulations}}
\vspace{-.3cm}
\centerline{$
...
\vspace{.5cm}
\centerline{\includegraphics[scale=3]{bijection}}
...
\item the Hasse diagram of the wiggly lattice on wiggly permutations.
\end{compactitem}
}
...
\emph{$\b{g}$-vector} of $\alpha =$ proj. on $\sum_{i = 1}^{2n} x_i = 0$ of \raisebox{-1.7cm}{\includegraphics[scale=4]{gvector}}

\vspace{-.5cm}
\emph{$\b{c}$-vector} of~$\alpha \in T = $ you don't want to know...

\vspace{.5cm}
\theo{PROP}{For any wiggly pseudotriangulation~$T$, the $\b{g}$-vectors~$\set{\b{g}(\alpha)}{\alpha \in T^\circ}$ and the $\b{c}$-vectors~$\set{\b{c}(\alpha, T)}{\alpha \in T^\circ}$ form dual bases.}

\vspace{1cm}
\centerline{\raisebox{-4cm}{\includegraphics[scale=4]{pseudotriangulationMatrices}} \quad \input{figures/gcmatrices}}
...
\vspace{.1cm}
\theo{THM}{The cones~$\setangle{\b{g}(\alpha)}{\alpha \in D}$ for all wiggly dissections~$D$ form a complete simplicial fan~$\wigglyFan_n$ (in $\sum_{i = 1}^{2n} x_i = 0$).
}

\vspace{2cm}
Main observation:

\centerline{\includegraphics[scale=3.2]{incompatible2}}
\centerline{
...
\vspace{1cm}
\centerline{\includegraphics[scale=1.7]{wigglyFlipGraph} \quad \input{figures/wigglyhedron}}
...
\vspace{.5cm}
\centerline{\includegraphics[scale=1.6]{wigglyCambrian1}}
...
\theo{QU 1a}{Is the wiggly flip graph Hamiltonian?

\hfill \color{gray}{[NB: wiggly permutations do not form a zigzag language, right?]}
}

\theo{QU 1b}{What is the diameter of the wiggly flip graph?
...
\begin{slide}{Open problem 2: wiggly pseudotriangulations of point sets}
...
\vspace*{-15cm}
\begin{minipage}{13cm}
\theo{Q2a}{Is~$\wigglyComplex_{\b{P}}$ the boundary complex of a simplicial polytope?
...
\vspace{1cm}
\theo{Q2b}{Is the graph of~$\wigglyComplex_{\b{P}}$ Hamiltonian?}
